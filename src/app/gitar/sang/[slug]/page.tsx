...
import { GuitarPlayerLazy } from '@/components/guitar/GuitarPlayerLazy'
import { AppShell } from '@/components/AppShell'

// Client-side load, same pattern as the piano song page: the song is fetched
// after mount, then handed to GuitarPlayerLazy which pulls in Tone.js only in
// the browser. Three states — loading, not found, and the player.
type State = { status: 'loading' } | { status: 'missing' } | { status: 'ready'; song: Song }

export default function GitarSangPage() {
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:py-10">
        ...
        {state.status === 'ready' && (
          <>
            ...
            <GuitarPlayerLazy song={state.song} />
