      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:py-10">
        ...
        {state.status === 'ready' && (
          <>
            ...
            <BassPlayerLazy song={state.song} />
